    ...
    <div className="col">
      <div className="card" >  
        ...
        <div className="card-body text-center">
          <h1 className="card-title text-center">Turf laptop</h1>
          <h1 className="card-title text-center">Rs. 3228643</h1>
          <p className="card-title text-center">This is the good compatible laptop.</p>
        </div>
